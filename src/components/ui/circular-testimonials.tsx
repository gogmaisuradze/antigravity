  ...
  return (
    <div className="testimonial-container w-full max-w-5xl mx-auto p-4 sm:p-8">
      <div className="testimonial-grid grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-center">
        ...
        {/* Content */}
        <div className="testimonial-content flex flex-col justify-between space-y-5">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p
                className="designation uppercase tracking-wider font-semibold text-xs mb-4"
                style={{ color: colorDesignation, fontSize: fontSizeDesignation }}
              >
                {activeTestimonial?.designation}
              </p>
              <motion.p
                className="quote font-light leading-relaxed text-sm sm:text-base italic"
